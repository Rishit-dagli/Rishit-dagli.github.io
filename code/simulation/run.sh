...
CLASSES=(
    ...
    "PhaseSpaceDark:phase_space"
    "EulerInstability:euler_instability"
    "EulerInstabilityDark:euler_instability"
    "BackwardEuler:backward_euler"
    "BackwardEulerDark:backward_euler"
    "SymplecticEuler:symplectic_euler"
    "SymplecticEulerDark:symplectic_euler"
    "MatrixAssembly:matrix_assembly"
    "MatrixAssemblyDark:matrix_assembly"
    "Spring3D:spring_3d"
    "Spring3DDark:spring_3d"
    "Constraints:constraints"
    "ConstraintsDark:constraints"
...
for class_config in "${CLASSES[@]}"; do
    ...
    # Run manim command
    manim $QUALITY_FLAG simulation.py $CLASS_NAME
    ...
    MEDIA_DIR="media/images/simulation"
    if [ ! -d "$MEDIA_DIR" ]; then
